...
// item chat messages
  Widget chatMessageItem(DocumentSnapshot snapshot) {
    ...
    return Container(
      ...
      child: Container(
        alignment: _message.senderId==_currentUser?Alignment.centerRight:Alignment.centerLeft,
        child: _message.senderId==_currentUser?senderLayout(_message):receiverLayout(_message)
      ),
    );
  }
          ...
          return Column(
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    FlatButton(onPressed:(){Navigator.pop(context);}, child: Icon(Icons.close)),
                    Expanded(child: Align(alignment: Alignment.centerLeft,child: Text('Tools',style: TextStyle(color:Colors.white,fontSize: 20,fontWeight: FontWeight.bold)))),
                  ],
...
// this container inCload emoji
  EmojiContainer() {
    return EmojiPicker(bgColor: UniversalVariables.separatorColor,
